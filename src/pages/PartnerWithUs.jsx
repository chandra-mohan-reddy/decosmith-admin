        ...
        <div className="page-content">
              ...
              <div className="page-title-box d-flex align-items-center justify-content-between">
                <div className="page-title-right">
                  <ol className="breadcrumb m-0">
                    ...
                    <li className="breadcrumb-item active"> Partner With Us</li>
                  </ol>
                </div>
              </div>
            </div>
          ...
          <div className='container'>
              <div className='card p-4'>
                <h4 className='sect-title mb-4'>Add Partner</h4>
                <form>
                ...
                <div className="col-md-4">
                  <div className="form-floating">
                    ...
                    <label for="project-type" className="fw-normal">Phone Number *</label>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="form-floating">
              ...
              <div className="card mt-4 p-4">
                <div className='row justify-content-between mb-4 align-items-center'>
                  <div className="col-md-9">
                    <h4 className='sect-title mb-0'>Partner With Us List</h4>
                  </div>
