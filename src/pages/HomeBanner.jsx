      ...
      <div className="page-content">
        ...
        <div className='container'>
          <div className='card p-4'>
            <h4 className='sect-title mb-4'>Add Home Banner</h4>
            <form>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-floating">
                    <select class="form-select" name="approval_authority" required="" fdprocessedid="bmlidh">
                      <option value="default">Select</option>
                      <option value="default">Hyderabad</option>
                      <option value="HMDA">Warangal</option>
                    </select>
                ...
                <div class="col-md-6">
                  <div class="form-floating">
                    <select class="form-select" name="approval_authority" required="" fdprocessedid="bmlidh">
                      ...
                      <option value="Featured">Elite</option>
                    </select>
          ...
          <div className="card mt-4 p-4">
            <div className='row justify-content-between mb-4 align-items-center'>
              <div className="col-md-9">
                <h4 className='sect-title mb-0'>Home Banner Lists</h4>
              </div>
